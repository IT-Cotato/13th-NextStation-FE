...
export default function ExploreLineTabs({
  ...
  return (
    <div
      className="flex min-h-[72px] w-full shrink-0 touch-pan-x flex-nowrap items-center gap-2 px-[15px] overflow-x-auto overflow-y-hidden overscroll-x-contain [scrollbar-width:none] [-webkit-overflow-scrolling:touch] focus:outline-none"
      role="tablist"
