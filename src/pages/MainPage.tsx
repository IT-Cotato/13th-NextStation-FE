    ...
    <section className='flex justify-center'>
      <div className='flex w-full'>
        ...
        <div className="relative h-full w-1/2">
          ...
          <button className='absolute left-5 top-[56%] z-10 flex items-center justify-center gap-2 px-6 py-4 rounded-full bg-linear-to-r from-primary-50 to-secondary-50 border-[2px] border-secondary-30 shadow-[0_0_8px_var(--color-secondary-50)]'>
        ...
        <div className="relative h-full w-1/2">
          ...
          <button className='absolute right-5 top-[56%] z-10 flex items-center justify-center gap-2 px-6 py-4 rounded-full bg-linear-to-r from-secondary-50 to-primary-50 border-[2px] border-secondary-30 shadow-[0_0_8px_var(--color-secondary-50)]'>
