...
function MainPage() {
  return (
    <main className="relative min-h-dvh bg-gray-10">
      {/* title */}
  ...
  <div className="absolute left-0 top-[234px] h-[10px] w-full bg-gray-20" />
      ...
      {/* Door */}
      <section className='absolute left-1/2 top-[244px] h-[600px] w-[390px] -translate-x-1/2'>
        <DoorLeft className="absolute left-0 top-0 h-[600px] w-[195px]" />
        <DoorRight className="absolute right-0 top-0 h-[600px] w-[195px]" />
        
        {/* 랜덤뽑기 버튼 */}
        <button className='absolute left-[97.5px] top-[340px] z-10 flex -translate-x-1/2 items-center justify-center gap-2 px-6 py-4 rounded-full bg-linear-to-r from-primary-50 to-secondary-50 border-[2px] border-secondary-30 shadow-[0_0_8px_var(--color-secondary-50)]'>
        ...
        <button className='absolute left-[292.5px] top-[340px] z-10 flex -translate-x-1/2 items-center justify-center gap-2 px-6 py-4 rounded-full bg-linear-to-r from-secondary-50 to-primary-50 border-[2px] border-secondary-30 shadow-[0_0_8px_var(--color-secondary-50)]'>
