...
export default function MyPageLineBadge({ line }: { line: SubwayLine }) {
  return (
    <div className={`flex px-[4px] rounded-full w-fit ${LINE_STYLES[line]}`}>
      <span className="flex items-center justify-center text-caption font-semibold leading-[1.4]">
        {line}
      </span>
    </div>
  );
